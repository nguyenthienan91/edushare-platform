...
export default function PricingPage() {
  return (
    <div className='min-h-screen bg-gradient-to-b from-white via-slate-50 to-indigo-50/40 text-slate-900'>
      <section className='mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:py-24'>
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className='text-center'>
          <span className='inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-white px-4 py-2 text-sm font-medium text-indigo-700 shadow-sm'>
        ...
        <div className='mt-12 grid gap-8 lg:grid-cols-[0.95fr_1.05fr]'>
          <motion.div
            ...
            className='rounded-[2rem] border border-indigo-100 bg-white p-8 shadow-lg shadow-slate-100'
          >
            <div className='flex items-start justify-between gap-4'>
              <div>
                <p className='text-sm font-semibold uppercase tracking-[0.2em] text-sky-600'>Main plan</p>
                <h2 className='mt-2 text-3xl font-bold text-slate-900'>29,000 VND / month</h2>
              </div>
          ...
          <div className='grid gap-5 sm:grid-cols-2'>
            <div className='rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm'>
              ...
              <p className='mt-2 text-sm leading-relaxed text-slate-600'>Your payment is protected until the group access is confirmed.</p>
            </div>
            <div className='rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm'>
              <Users className='h-6 w-6 text-sky-600' />
              <h3 className='mt-4 text-lg font-bold'>Trusted communities</h3>
              <p className='mt-2 text-sm leading-relaxed text-slate-600'>Join student-friendly groups with clear trust scores and reviews.</p>
            </div>
            <div className='rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm'>
              <BadgeCheck className='h-6 w-6 text-orange-500' />
              <h3 className='mt-4 text-lg font-bold'>Trust score system</h3>
              <p className='mt-2 text-sm leading-relaxed text-slate-600'>See reliability indicators before you join a group.</p>
            </div>
            <div className='rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm'>
              <Star className='h-6 w-6 text-violet-600' />
              <h3 className='mt-4 text-lg font-bold'>Priority support</h3>
              <p className='mt-2 text-sm leading-relaxed text-slate-600'>Get help faster when you need assistance or dispute support.</p>
            </div>
          </div>
        </div>
        ...
        <div className='mt-12 grid gap-8 lg:grid-cols-[1fr_1fr]'>
          ...
          <div className='rounded-[2rem] bg-gradient-to-br from-indigo-600 to-sky-500 p-8 text-white shadow-lg shadow-sky-100'>
            ...
            <Link
              to='/login'
              className='mt-8 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3.5 font-semibold text-indigo-700 transition-transform hover:-translate-y-0.5'
            >
