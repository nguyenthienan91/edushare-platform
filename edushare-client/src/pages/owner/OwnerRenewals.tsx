    ...
    >
      <div className="space-y-6 bg-[#f0f9ff]">
        <div className="rounded-3xl border border-sky-100/80 bg-white p-6 shadow-sm shadow-sky-100/50">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900">Nhắc nhở gia hạn</h2>
        ...
        <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <Card className="rounded-3xl border-slate-200/70 bg-white shadow-sm shadow-sky-100/30">
            <CardHeader>
              <CardTitle className="text-slate-900">Danh sách nhóm cần chú ý</CardTitle>
          ...
          <Card className="rounded-3xl border-slate-200/70 bg-white shadow-sm shadow-sky-100/30">
            <CardHeader>
              <CardTitle className="text-slate-900">Gợi ý nhanh</CardTitle>
              <CardDescription>Những điều nên làm để giữ cộng đồng ổn định.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="rounded-2xl bg-sky-50 p-4">
                <p className="font-medium text-slate-900">Gửi nhắc trước 3 ngày</p>
                <p className="mt-1 text-sm leading-6 text-slate-500">
                  Gửi lời nhắc sớm giúp thành viên chủ động gia hạn và tránh gián đoạn.
                </p>
              </div>
              <div className="rounded-2xl bg-sky-50 p-4">
                <p className="font-medium text-slate-900">Theo dõi phản hồi</p>
                <p className="mt-1 text-sm leading-6 text-slate-500">
