            ...
            <CardContent>
              <div className="rounded-xl /70 p-4">
                <svg viewBox={`0 0 ${chartWidth} ${chartHeight}`} className="h-[260px] w-full overflow-visible">
                  ...
                  <path d={linePath} fill="none" stroke="#38bdf8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                  ...
                  {weeklyMembers.map((value, index) => {
                    ...
                    return (
                      <g key={`${value}-${index}`}>
                        ...
                        <text x={x} y={chartHeight - 4} textAnchor="middle" className="fill-slate-400 text-[12px] font-medium">
