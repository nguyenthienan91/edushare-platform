...
type OrderStatus = 'pending_payment' | 'confirmed' | 'pending_access' | 'released' | 'disputed' | 'refunded' | 'cancelled'
...
const orders: OrderItem[] = [
  { id: '#q43v8lq4g', groupName: 'Canva', icon: '🎨', price: 39000, createdAt: '17/05/2026', status: 'pending_access', nextAction: 'Chờ chủ nhóm cấp quyền', ownerName: 'Nguyễn Minh Anh' },
  { id: '#n92k1p8xa', groupName: 'ChatGPT', icon: '✨', price: 59000, createdAt: '16/05/2026', status: 'confirmed', nextAction: 'Chủ nhóm đang xác nhận', ownerName: 'Trần Gia Huy' },
  { id: '#a71m5c2zq', groupName: 'Adobe', icon: '🖌️', price: 69000, createdAt: '14/05/2026', status: 'released', nextAction: 'Đã giải ngân', ownerName: 'Phạm Quốc Bảo' },
  { id: '#k11t0d9xr', groupName: 'Microsoft 365', icon: '💼', price: 45000, createdAt: '12/05/2026', status: 'disputed', nextAction: 'Đang chờ admin xử lý', ownerName: 'Lê Hoàng Long' },
  { id: '#p88w4z6vn', groupName: 'Notion', icon: '🗒️', price: 29000, createdAt: '08/05/2026', status: 'refunded', nextAction: 'Đã hoàn tiền về ví', ownerName: 'Võ Thảo Vy' },
]
...
export default function MemberParticipantOrdersPage() {
  ...
  const activeOrders = useMemo(() => orders.filter((order) => !['released', 'refunded', 'cancelled'].includes(order.status)), [])
            ...
            >
              ...
              <div className="grid gap-6 p-6">
                ...
                <div className="flex flex-wrap justify-end gap-3 border-t border-slate-100 pt-4">
                  ...
                  <button type="button" className="inline-flex items-center gap-2 rounded-2xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">
