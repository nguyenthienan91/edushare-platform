    ...
    <div className="max-w-7xl mx-auto space-y-6 p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        ...
        <div className="flex gap-3 w-full sm:w-auto">
          ...
          <button className="px-3 py-2 border rounded-md hover:bg-muted flex items-center gap-2">
            ...
            >
              <div className="p-5">
                ...
                <div className="flex justify-between mb-4">
                  ...
                  <div className="flex items-center gap-1 bg-amber-500/10 text-amber-500 px-2 py-1 rounded-md text-xs">
                ...
                {/* Rules */}
                <div className=" p-3 rounded-md text-xs bg-muted/50">
              ...
              <div className="border-t p-4 flex items-center justify-between ">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90"
                >
                  Tham gia
                </button>
              </div>
        ...
        {showPopup && selectedListing && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0.95 }}
              className=" rounded-lg w-full max-w-md overflow-hidden bg-card border"
            >
              {/* Header */}
              <div className="bg-amber-500/10 p-6 text-center border-b border-amber-500/20">
                ...
                <h3 className="font-bold text-lg text-amber-600">
                  Cảnh báo pháp lý
                </h3>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    onClick={confirmJoin}
                    className="flex-1 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                    Thanh toán
        ...
        {showVipPopup && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md overflow-hidden rounded-lg bg-card p-6 shadow-lg border"
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex w-full flex-col gap-3">
                  <button
                    ...
                    className="flex w-full items-center justify-center rounded-md bg-primary py-3 text-sm font-semibold text-primary-foreground transition hover:bg-primary/95"
                  >
                    Nâng cấp VIP ngay
                  </button>
                  <button
                    onClick={() => setShowVipPopup(false)}
                    className="flex w-full items-center justify-center rounded-md border py-3 text-sm font-semibold transition hover:bg-muted"
                  >
                    Để sau
                  </button>
                </div>
