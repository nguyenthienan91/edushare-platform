...
import { BadgeCheck, CirclePlus, Search, ShieldCheck, Trash2, Users } from 'lucide-react'
...
export default function MemberManageGroup() {
  ...
  return (
    <div className='space-y-6 '>
      <Card>
        <CardContent>
          <Badge className='rounded-full bg-indigo-100 text-indigo-700 hover:bg-indigo-100'>Manage Group</Badge>
